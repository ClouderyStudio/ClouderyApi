...
public static class MhopBoards
{
    public static readonly IReadOnlyList<MhopBoard> All =
    [
    ...
    public static readonly HashSet<string> Slugs = All.Select(b => b.Slug).ToHashSet(StringComparer.Ordinal);
}
